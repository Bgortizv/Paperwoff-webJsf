...
@SessionScoped
public class TutoresController implements Serializable {

    private Tutores current;
    ...
    public String prepareView() {
        current = (Tutores) getItems().getRowData();
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/Bundle").getString("TutoresUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/Bundle").getString("TutoresDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Tutores getTutores(java.lang.Long id) {
        return ejbFacade.find(id);
    }

    @FacesConverter(forClass = Tutores.class)
    public static class TutoresControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            TutoresController controller = (TutoresController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "tutoresController");
            return controller.getTutores(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Tutores) {
                Tutores o = (Tutores) object;
                return getStringKey(o.getIdTutores());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Tutores.class.getName());
            }
        }
